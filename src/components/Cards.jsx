...
const Cards = ({foto,counters,good,spell,runaPrimaria,runaSecundaria,tier,nome,itens}) => {
    ...
    return (
        <div style={{ borderRadius:'15px',width: '480px', height: '700px', float: 'left', marginLeft: '120px', marginTop: '50px', maxHeight: '700px', backgroundColor: '#323336', boxShadow: 'rgb(0 0 0 / 19%) 0px 10px 20px, rgb(0 0 0 / 23%) 0px 6px 6px',border:'0.5px solid black' }} className = 'card'>
