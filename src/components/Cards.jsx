...
const Cards = ({foto,counters,good,spell,runaPrimaria,runaSecundaria,tier,nome,itens}) => {
    ...
    return (
        <div style={{ borderRadius:'15px',width: '25%',maxWidth:'520px', height: '700px', float: 'left', marginLeft: '6.5%', marginTop: '50px', maxHeight: '700px', backgroundColor: '#323336', boxShadow: 'rgb(0 0 0 / 19%) 0px 10px 20px, rgb(0 0 0 / 23%) 0px 6px 6px',border:'0.5px solid black' }} className = 'card'>
            ...
            <div style={{ marginTop: '4%', width: '90%', marginLeft: '5%',display:'flex',justifyContent:'center'}}>
            ...
            {estado && <div className='runaBox' style={{ padding: '10px', height: '52%', width: '90%', marginLeft: '5%', marginTop: '8%' }}>
                <div style={{ width: '100%', height: '33%', display: 'flex', justifyContent: 'center' }}>
                    ...
                    <img alt='' src={itens[0]} style={{ width: '20%', height: '70%',marginTop:'5%', marginLeft: ' 3%',marginRight: ' 4%' }}></img>
                </div>
                <div style={{ width: '100%', height: '18%', display: 'flex', justifyContent: 'center', marginTop: '2%' }}>
                    ...
                    <img alt='' src={itens[1]} style={{ width: '20%', height: '120%',marginTop:'0%', marginLeft: '12%'}}></img>
                </div>
                <div style={{ width: '100%', height: '18%', display: 'flex', justifyContent: 'center', marginTop: '2%' }}>
